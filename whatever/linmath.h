...
#define LINMATH_H_DEFINE_I_VEC(n, bitsize) \
typedef int##bitsize##_t i##bitsize##vec##n_comp_t; \
typedef int##bitsize##_t i##bitsize##vec##n[n]; \
LINMATH_H_FUNC void i##bitsize##vec##n##_add(i##bitsize##vec##n r, i##bitsize##vec##n const a, i##bitsize##vec##n const b) \
{ \
    int i; \
    for(i=0; i<n; ++i) \
        r[i] = a[i] + b[i]; \
} \
LINMATH_H_FUNC void i##bitsize##vec##n##_sub(i##bitsize##vec##n r, i##bitsize##vec##n const a, i##bitsize##vec##n const b) \
{ \
    int i; \
    for(i=0; i<n; ++i) \
        r[i] = a[i] - b[i]; \
} \
LINMATH_H_FUNC void i##bitsize##vec##n##_scale(i##bitsize##vec##n r, i##bitsize##vec##n const v, int##bitsize##_t const s) \
{ \
    int i; \
    for(i=0; i<n; ++i) \
        r[i] = v[i] * s; \
} \
LINMATH_H_FUNC int##bitsize##_t i##bitsize##vec##n##_mul_inner(i##bitsize##vec##n const a, i##bitsize##vec##n const b) \
{ \
    float p = 0.f; \
    int i; \
    for(i=0; i<n; ++i) \
...
LINMATH_H_FUNC void i##bitsize##vec##n##_min(i##bitsize##vec##n r, i##bitsize##vec##n const a, i##bitsize##vec##n const b) \
{ \
    int i; \
    for(i=0; i<n; ++i) \
        r[i] = a[i]<b[i] ? a[i] : b[i]; \
} \
LINMATH_H_FUNC void i##bitsize##vec##n##_max(i##bitsize##vec##n r, i##bitsize##vec##n const a, i##bitsize##vec##n const b) \
{ \
    int i; \
    for(i=0; i<n; ++i) \
        r[i] = a[i]>b[i] ? a[i] : b[i]; \
} \
LINMATH_H_FUNC void i##bitsize##vec##n##_dup(i##bitsize##vec##n r, i##bitsize##vec##n const src) \
{ \
    int i; \
    for(i=0; i<n; ++i) \
        r[i] = src[i]; \
}\
LINMATH_H_FUNC void i##bitsize##vec##n##_negate(i##bitsize##vec##n r, i##bitsize##vec##n const src) \
{ \
    int i; \
    for(i=0; i<n; ++i) \
        r[i] = -src[i]; \
...
LINMATH_H_FUNC void vec##n##_neg(vec##n r, vec##n const src) \
{ \
    int i; \
    for(i=0; i<n; ++i) \
        r[i] = -src[i]; \
...
LINMATH_H_DEFINE_I_VEC(4, 32)
LINMATH_H_DEFINE_I_VEC(2, 32)

LINMATH_H_DEFINE_VEC(2)
LINMATH_H_DEFINE_VEC(3)
LINMATH_H_DEFINE_VEC(4)

LINMATH_H_FUNC void i32vec2_calc_normal(i32vec2 r, i32vec2 src)
{
    r[0] = src[1];
    r[1] = -src[0];
}

LINMATH_H_FUNC void vec2_calc_normal(vec2 r, vec2 src)
{
    r[0] = src[1];
    r[1] = -src[0];
}

LINMATH_H_FUNC void vec2_project_v_on_u(vec2 r, vec2 v, vec2 u)
{
    float d = vec2_mul_inner(v, u);
    float m = vec2_len(u);
    float m2 = m * m;
    float s = d / m2;
